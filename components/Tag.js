  ...
  if (kebabCase(text) === 'notion') {
    return (
      <Link href={`/tags/${kebabCase(text)}`}>
        <a
          className="mt-1 mr-3 rounded border-2 border-solid border-black bg-violet-700 px-2 text-sm font-medium
          uppercase
    ...
    return (
      <Link href={`/tags/${kebabCase(text)}`}>
        <a
          className="mt-1 mr-3 rounded border-2 border-solid border-black bg-white p-0 text-sm font-medium
          uppercase
        text-black transition duration-500
        ease-out hover:border-primary-500
         hover:text-primary-500 dark:border-gray-300
        dark:text-gray-300 dark:hover:border-primary-400
