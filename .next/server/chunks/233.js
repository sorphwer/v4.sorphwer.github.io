...
exports.ids = [233]
exports.modules = {
  /***/ 233: /***/ (__webpack_module__, __webpack_exports__, __webpack_require__) => {
    __webpack_require__.a(
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          /* harmony import */ var _matejmazur_react_katex__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(1618)
          /* harmony import */ var notion_utils__WEBPACK_IMPORTED_MODULE_2__ =
          ...
          var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([
            notion_utils__WEBPACK_IMPORTED_MODULE_2__,
          ])
          notion_utils__WEBPACK_IMPORTED_MODULE_2__ = (
          ...
          var EOI = ({ block, inline, className }) => {
            ...
            const lastUpdated = lastUpdatedAt
              ? (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.formatNotionDateTime)(lastUpdatedAt)
              : null
            let externalImage
            switch (domain) {
              case 'github.com':
          ...
          var LazyImage = (_a) => {
            ...
            const previewImage = previewImages
              ? (_c =
                ...
                ? void 0
                : _b2[(0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.normalizeUrl)(src)]
              : null
          ...
          var PageIconImpl = ({
            ...
            if (isIconBlock(block)) {
              const icon =
                ((_a = (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.getBlockIcon)(
                  block,
                  recordMap
                )) == null
                  ? void 0
                  : _a.trim()) || defaultIcon
              const title = (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.getBlockTitle)(
                block,
                recordMap
              )
                    ...
                    const formatted = decorations.reduce((element, decorator) => {
                      ...
                      switch (decorator[0]) {
                        ...
                        case 'a': {
                          ...
                          const id = (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.parsePageId)(
                            pathname,
                            { uuid: true }
                          )
                        ...
                        case 'd': {
                          ...
                          if (type === 'date') {
                            ...
                            return (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.formatDate)(
                              startDate
                            )
                            ...
                            return `${(0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.formatDate)(
                              startDate
                            )} \u2192 ${(0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.formatDate)(
                              endDate
                            )}`
                          } else {
                            return element
                  ...
                  if (result.error || result.errorId) {
                    ...
                    const results = searchResult.results
                      .map((result2) => {
                        ...
                        result2.page =
                          (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.getBlockParentPage)(
                            block,
                            searchResult.recordMap,
                            {
                              inclusive: true,
          ...
          var Breadcrumbs = ({ block, rootOnly = false }) => {
            ...
            const breadcrumbs = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
              ...
              notion_utils__WEBPACK_IMPORTED_MODULE_2__.getPageBreadcrumbs)(recordMap, block.id)
              if (rootOnly) {
          ...
          var Asset = ({ block, zoomable = true, children }) => {
            ...
            if (block.type === 'tweet') {
              ...
              const caption = (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.getTextContent)(
            ...
            if (block.type === 'image') {
              const caption =
                (_c =
                  ...
                  : _c[0]
              if (caption) {
                const id = (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.parsePageId)(caption, {
                  uuid: true,
                })
          ...
          var Equation = (_a) => {
            ...
            const { recordMap } = useNotionContext()
            math =
              math || (0, notion_utils__WEBPACK_IMPORTED_MODULE_2__.getBlockTitle)(block, recordMap)
            if (!math) return null
            return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              'span',
              {
              ...
              /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                _matejmazur_react_katex__WEBPACK_IMPORTED_MODULE_1__,
                __spreadValues(
                  {
                    math,
