...
exports.ids = [664]
exports.modules = {
  /***/ 1551: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict'
    ...
    function prefetch(router, href, as, options) {
      ...
      const curLocale =
        options && typeof options.locale !== 'undefined' ? options.locale : router && router.locale
  ...
  /***/ 2700: /***/ (__unused_webpack_module, exports) => {
    'use strict'
  ...
  /***/ 2497: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict'
        ...
        loadRoute(route, prefetch) {
          return withFuture(route, routes, () => {
            ...
            return resolvePromiseWithTimeout(
              ...
              .finally(() => {
                return devBuildPromiseResolve === null || devBuildPromiseResolve === void 0
                  ? void 0
  ...
  /***/ 9246: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 9977: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 1003: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    function addPathPrefix(path, prefix) {
      ...
      return (
        (0, _normalizeTrailingSlash).normalizePathTrailingSlash(`${prefix}${pathname}`) +
    ...
    class Router {
      constructor(
        ...
        const autoExportDynamic =
          (0, _isDynamic).isDynamicRoute(pathname1) && self.__NEXT_DATA__.autoExport
      ...
      async change(method, url, as, options, forcedScroll) {
        ...
        const shouldResolveHref =
          options._h || options._shouldResolveHref || pathNoQueryHash(url) === pathNoQueryHash(as)
        const nextState = {
          ...this.state,
        }
         ...
         */ if (
          ...
          (options._h !== 1 ||
            (0, _isDynamic).isDynamicRoute(
              (0, _normalizeTrailingSlash).removePathTrailingSlash(pathname)
            ))
        ) {
        ...
        try {
          ...
          if (
            options._h &&
            pathname === '/_error' &&
            ((ref1 = self.__NEXT_DATA__.props) === null || ref1 === void 0
              ? void 0
              : (ref2 = ref1.pageProps) === null || ref2 === void 0
              ? void 0
              : ref2.statusCode) === 500 &&
          ...
          await this.set(
            ...
            routeInfo,
            forcedScroll !== null && forcedScroll !== void 0 ? forcedScroll : resetScroll
          ).catch((e) => {
      ...
      async handleRouteInfoError(err, pathname, query, as, routeProps, loadErrorFail) {
        ...
        try {
          ...
          return this.handleRouteInfoError(
            (0, _isError).default(routeInfoErr) ? routeInfoErr : new Error(routeInfoErr + ''),
            pathname,
            query,
            as,
            routeProps,
      ...
      async _preflightRequest(options) {
        ...
        if (preflight.rewrite) {
          ...
          const parsed = (0, _parseRelativeUrl).parseRelativeUrl(
            (0, _normalizeLocalePath).normalizeLocalePath(
              hasBasePath(preflight.rewrite) ? delBasePath(preflight.rewrite) : preflight.rewrite,
              this.locales
            ).pathname
          )
        ...
        if (preflight.redirect) {
          if (preflight.redirect.startsWith('/')) {
            const cleanRedirect = (0, _normalizeTrailingSlash).removePathTrailingSlash(
              (0, _normalizeLocalePath).normalizeLocalePath(
