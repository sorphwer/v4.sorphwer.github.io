...
exports.ids = [635]
exports.modules = {
  /***/ 635: /***/ (__webpack_module__, __webpack_exports__, __webpack_require__) => {
    __webpack_require__.a(
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          /* harmony import */ var react_image__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(9358)
          /* harmony import */ var react_lazy_images__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(5830)
          /* harmony import */ var react_hotkeys_hook__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(2784)
          /* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_6__ =
          ...
          var require_getUTCISOWeek = __commonJS({
            '../../node_modules/date-fns/_lib/getUTCISOWeek/index.js'(exports, module) {
              ...
              function getUTCISOWeek(dirtyDate) {
                ...
                var date = (0, _index.default)(dirtyDate)
                var diff =
                  (0, _index2.default)(date).getTime() - (0, _index3.default)(date).getTime()
                ...
                if (token === 'YYYY') {
                  ...
                  throw new RangeError(
                    'Use `d` instead of `D` (in `'
                      .concat(format4, '`) for formatting days of the month to the input `')
                      .concat(input, '`; see: https://git.io/fxCyr')
                  )
                } else if (token === 'DD') {
                  throw new RangeError(
            ...
            '../../node_modules/format-number/index.js'(exports, module) {
              ...
              function formatter(options) {
                ...
                options.decimalsSeparator =
                  typeof options.decimalsSeparator === 'string' ? options.decimalsSeparator : ''
          ...
          var require_add = __commonJS({
            '../../node_modules/date-fns/add/index.js'(exports, module) {
              ...
              function add2(dirtyDate, duration) {
                ...
                var dateWithMonths =
                  months || years ? (0, _index2.default)(date, months + years * 12) : date
                var dateWithDays =
                  days || weeks
          ...
          var GracefulImage = (props) => {
            if (isBrowser) {
              return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                react_image__WEBPACK_IMPORTED_MODULE_3__.Img,
          ...
          var LazyImage = (_a) => {
            ...
            if (previewImage) {
              ...
              return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                react_lazy_images__WEBPACK_IMPORTED_MODULE_4__ /* .LazyImageFull */.AZ,
                __spreadProps(
                  __spreadValues(
                    {
                      src,
                ...
                ({ imageState, ref }) => {
                  const isLoaded =
                    imageState ===
                    react_lazy_images__WEBPACK_IMPORTED_MODULE_4__ /* .ImageState.LoadSuccess */.zl
                      .LoadSuccess
                  const wrapperStyle = {
                    width: '100%',
                  }
                  ...
                  if (isNaN(value)) {
                    ...
                    switch (schema.number_format) {
                      ...
                      case 'pound':
                        ...
                        break
                      case 'yen':
                        output = (0, import_format_number.default)({ prefix: '\xA5', round: 0 })(
                          value
                        )
                        break
                      case 'rupee':
                        ...
                        break
                      case 'won':
                        output = (0, import_format_number.default)({ prefix: '\u20A9', round: 0 })(
                          value
                        )
                        break
                      case 'yuan':
          ...
          var CollectionCard = (_a) => {
            var _b = _a,
              { collection, block, cover, coverSize, coverAspect, properties, className } = _b,
              rest = __objRest(_b, [
                'collection',
                'block',
                'cover',
            ...
            if ((cover == null ? void 0 : cover.type) === 'page_content') {
              ...
              if (contentBlockId) {
                ...
                const source =
                  (_g =
                    (_e =
                      (_d = (_c = contentBlock.properties) == null ? void 0 : _c.source) == null
                        ? void 0
                        : _d[0]) == null
                      ? void 0
                      : _e[0]) != null
                ...
                if (source) {
                  ...
                  const caption =
                    (_j =
                      (_i = (_h = contentBlock.properties) == null ? void 0 : _h.caption) == null
                        ? void 0
                        : _i[0]) == null
                      ? void 0
                      : _j[0]
                  coverContent = /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                    LazyImage,
                    {
                      src,
              ...
              if (page_cover) {
                ...
                coverContent = /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                  LazyImage,
                  {
                    ...
                    alt: (0, notion_utils__WEBPACK_IMPORTED_MODULE_1__.getTextContent)(
            ...
            const innerCard = /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              react__WEBPACK_IMPORTED_MODULE_0__.Fragment,
              null,
              ...
              /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                ...
                /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                  ...
                  /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(Property, {
                    ...
                    data:
                      (_n = block == null ? void 0 : block.properties) == null ? void 0 : _n.title,
                    block,
                    collection,
                  })
                ),
          ...
          // src/third-party/collection-view-board.tsx
          var CollectionViewBoard = ({ collection, collectionView, collectionData, padding }) => {
            var _a
                    ...
                    const group =
                      collectionData[
                        `results:${
                          ...
                          ((_d = p == null ? void 0 : p.value) == null ? void 0 : _d.value) ||
                          'uncategorized'
                        }`
                      ]
                    if (!group || !schema || p.hidden) {
                    ...
                    : blockIds.map((blockId) => {
                        ...
                        return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                          CollectionCard,
                          {
                            ...
                            properties:
                              (_b = collectionView.format) == null ? void 0 : _b.gallery_properties,
                            key: blockId,
                          }
                        )
                      })
          ...
          var CollectionViewList = ({ collection, collectionView, collectionData }) => {
            ...
            const blockIds =
              ((_c =
                (_b = collectionData['collection_group_results']) == null ? void 0 : _b.blockIds) !=
              null
                ? _c
                    ...
                    : blockIds.map((blockId) => {
                        ...
                        return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                          ...
                          /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                            ...
                            (_d =
                              (_c = collectionView.format) == null ? void 0 : _c.list_properties) ==
                              null
                              ? void 0
                              : _d
                                  .filter((p) => p.visible)
                                  .map((p) => {
                                    ...
                                    const data =
                                      block &&
                                      ((_a2 = block.properties) == null ? void 0 : _a2[p.property])
                                    if (!schema) {
                                      return null
                                    }
                                    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                            ...
                            /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                              ...
                              properties.map((p) => {
                                ...
                                const schema =
                                  (_a2 = collection.schema) == null ? void 0 : _a2[p.property]
                                const block =
                                  (_b = recordMap.block[blockId]) == null ? void 0 : _b.value
                                const data =
          ...
          var CollectionViewBlock = ({ block, className }) => {
            ...
            notion_utils__WEBPACK_IMPORTED_MODULE_1__.getBlockCollectionId)(block, recordMap)
            const [isMounted, setIsMounted] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false)
            react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
              setIsMounted(true)
            }, [])
            const defaultCollectionViewId = viewIds[0]
            const [collectionState, setCollectionState] = (0,
            react_use__WEBPACK_IMPORTED_MODULE_2__.useLocalStorage)(block.id, {
            ...
            const collectionView =
              (_b = recordMap.collection_view[collectionViewId]) == null ? void 0 : _b.value
            const collectionData =
              (_c = recordMap.collection_query[collectionId]) == null
                ? void 0
                : _c[collectionViewId]
            const parentPage = (0, notion_utils__WEBPACK_IMPORTED_MODULE_1__.getBlockParentPage)(
              block,
              recordMap
            )
            const { width, padding } = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
              ...
              if (
                ...
                notionBodyWidth =
                  width2 < maxNotionBodyWidth ? (width2 - width2 * 0.02) | 0 : maxNotionBodyWidth
              }
            ...
            const title = (0, notion_utils__WEBPACK_IMPORTED_MODULE_1__.getTextContent)(
              collection.name
            ).trim()
            const showTitle =
              ((_d = collectionView.format) == null ? void 0 : _d.hide_linked_collection_name) !==
                true && title
            if (collection.icon) {
              ...
              viewIds.map((viewId) => {
                ...
                return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                  ...
                  /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                    ...
                    {
                      collectionView:
                        (_a = recordMap.collection_view[viewId]) == null ? void 0 : _a.value,
                    }
                  )
                )
              })
          ...
          var CollectionViewColumnDesc = (_a) => {
            ...
            return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              ...
              /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(CollectionViewIcon, {
