...
exports.ids = [726]
exports.modules = {
  /***/ 7726: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    const NewsletterForm = ({ title = 'Subscribe to the newsletter' }) => {
      ...
      const { 0: subscribed, 1: setSubscribed } = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
        false
      )
      const subscribe = async (e) => {
        e.preventDefault()
        const res = await fetch(
          `/api/${_data_siteMetadata__WEBPACK_IMPORTED_MODULE_2___default().newsletter.provider}`,
          {
            body: JSON.stringify({
    ...
    const BlogNewsletterForm = ({ title }) =>
      /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx('div', {
