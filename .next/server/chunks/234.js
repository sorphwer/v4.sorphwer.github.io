...
exports.ids = [234]
exports.modules = {
  /***/ 8234: /***/ (module, __webpack_exports__, __webpack_require__) => {
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          /* harmony import */ var gray_matter__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(gray_matter__WEBPACK_IMPORTED_MODULE_1__)
          ...
          /* harmony import */ var _utils_kebabCase__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(4871)
          var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([
            _mdx__WEBPACK_IMPORTED_MODULE_3__,
          ])
          _mdx__WEBPACK_IMPORTED_MODULE_3__ = (
          ...
          async function getAllTags(type) {
            ...
            files.forEach((file) => {
              const source = fs__WEBPACK_IMPORTED_MODULE_0___default().readFileSync(
                path__WEBPACK_IMPORTED_MODULE_2___default().join(root, 'data', type, file),
                'utf8'
              )
              const { data } = gray_matter__WEBPACK_IMPORTED_MODULE_1___default()(source)
              if (data.tags && data.draft !== true) {
                const tags = [data.notion ? 'Notion' : 'mdx', ...data.tags]
                tags.forEach((tag) => {
                  const formattedTag = (0,
                  _utils_kebabCase__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.Z)(tag)
