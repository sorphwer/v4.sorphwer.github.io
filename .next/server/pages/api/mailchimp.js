...
;(() => {
  ...
  exports.ids = [65]
  exports.modules = {
    /***/ 7368: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var mailchimp_marketing_default = /*#__PURE__*/ __webpack_require__.n(
        mailchimp_marketing_namespaceObject
      ...
      /* harmony default export */ const mailchimp = async (req, res) => {
        ...
        try {
          const test = await mailchimp_marketing_default().lists.addListMember(
