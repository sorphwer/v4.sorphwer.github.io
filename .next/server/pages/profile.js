...
;(() => {
  ...
  exports.ids = [277]
  exports.modules = {
    /***/ 2794: /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
          try {
            ...
            async function getStaticProps() {
              const authorDetails = await (0,
              _lib_mdx__WEBPACK_IMPORTED_MODULE_2__ /* .getFileBySlug */.x7)('authors', ['default'])
              //notion
              let recordMap = null
            ...
            function Profile({ authorDetails, recordMap }) {
