  ...
  [873],
  {
    ...
    9983: function (e, t, n) {
        ...
        function t() {
          ...
          return (
            ...
            (r.renderPortal = function (e) {
              var n = g()(
                r,
                l.default.createElement(u.default, o({ defaultStyles: t.defaultStyles }, e)),
                r.node
              )
              r.portalRef(n)
            }),
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  if (f.canUseDOM) {
                    ...
                    var l = n.prevParent,
                      s = n.nextParent
                    s !== l && (l.removeChild(this.node), s.appendChild(this.node)),
                    ...
                    ? (!this.node && O && (this.node = C('div')),
                      g()(
                        l.default.createElement(
                          u.default,
                          o({ ref: this.portalRef, defaultStyles: t.defaultStyles }, this.props)
                        ),
                        this.node
                      ))
                    : null
      ...
      ;(S.propTypes = {
        ...
        style: i.default.shape({ content: i.default.object, overlay: i.default.object }),
            ...
            return (
              ...
              (n.afterClose = function () {
                var e = n.props,
                  ...
                  l = e.parentSelector,
                  s = (l && l().ownerDocument) || document
                a && f.remove(s.body, a),
                  r && f.remove(s.getElementsByTagName('html')[0], r),
                  o && b > 0 && 0 === (b -= 1) && c.show(t),
                  n.props.shouldFocusAfterRender &&
                    (n.props.shouldReturnFocusAfterClose
                      ? (i.returnFocus(n.props.preventScroll), i.teardownScopedFocus())
                      : i.popWithoutFocus()),
              ...
              (n.open = function () {
                n.beforeOpen(),
                  n.state.afterOpen && n.state.beforeClose
                    ...
                    : (n.props.shouldFocusAfterRender &&
                        (i.setupScopedFocus(n.node), i.markForFocusLater()),
            ...
            a(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  r && f.add(l.body, r),
                    o && f.add(l.getElementsByTagName('html')[0], o),
                    n && ((b += 1), c.hide(t)),
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.hide = function (e) {
          var t = !0,
            ...
            o = void 0
          try {
            for (var r, a = u(e)[Symbol.iterator](); !(t = (r = a.next()).done); t = !0) {
    ...
    5063: function (e, t, n) {
      ...
      a.default.subscribe(function (e, t) {
        l ||
          s ||
          ((l = document.createElement('div')).setAttribute('data-react-modal-body-trap', ''),
          (l.style.position = 'absolute'),
          (l.style.opacity = '0'),
          l.setAttribute('tabindex', '0'),
          l.addEventListener('focus', u),
          (s = l.cloneNode()).addEventListener('focus', u)),
          (i = t).length > 0
    ...
    2409: function (e, t) {
      ...
      ;(t.add = function (e, t) {
        return (
          (r = e.classList),
          (a = 'html' == e.nodeName.toLowerCase() ? n : o),
    ...
    9685: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.returnFocus = function () {
          var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            t = null
          try {
            return void (0 !== l.length && (t = l.pop()).focus({ preventScroll: e }))
          } catch (n) {
            console.warn(
        ...
        (t.setupScopedFocus = function (e) {
          ;(s = e),
            window.addEventListener
              ? (window.addEventListener('blur', u, !1), document.addEventListener('focus', c, !0))
      ...
      function c() {
        if (i) {
          if (((i = !1), !s)) return
          setTimeout(function () {
            s.contains(document.activeElement) || ((0, a.default)(s)[0] || s).focus()
          }, 0)
        }
      }
    },
    ...
    8338: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e, t) {
          ...
          var f = n.indexOf(u)
          f > -1 && (f += r ? -1 : 1)
          if ('undefined' === typeof (o = n[f]))
            return t.preventDefault(), void (o = r ? i : s).focus()
