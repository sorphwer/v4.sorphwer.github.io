  ...
  [488],
  {
    3063: function (t, e) {
      ...
      ;(e.Q = s),
        ...
        (s.prototype.emit = function (t) {
          this._callbacks = this._callbacks || {}
          for (
            var e = new Array(arguments.length - 1), s = this._callbacks['$' + t], n = 1;
            n < arguments.length;
            n++
          )
            e[n - 1] = arguments[n]
    ...
    1830: function (t, e) {
      ;(e.encode = function (t) {
        ...
        for (var s in t)
          t.hasOwnProperty(s) &&
            (e.length && (e += '&'), (e += encodeURIComponent(s) + '=' + encodeURIComponent(t[s])))
        return e
      }),
        (e.decode = function (t) {
    ...
    4187: function (t) {
      ...
      t.exports = function (t) {
        ...
        ;-1 != r &&
          -1 != i &&
          (t = t.substring(0, r) + t.substring(r, i).replace(/:/g, ';') + t.substring(i, t.length))
        for (var o = e.exec(t || ''), a = {}, c = 14; c--; ) a[s[c]] = o[c] || ''
        return (
          -1 != r &&
            -1 != i &&
            ((a.source = n),
    ...
    2488: function (t, e, s) {
      ...
      function u(t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = h.bind(o)), (t.clearTimeoutFn = p.bind(o)))
      ...
      const _ = 'function' === typeof ArrayBuffer,
        ...
        C = (t, e) => ('blob' === e && t instanceof ArrayBuffer ? new Blob([t]) : t)
      var R = (t, e) => {
        if ('string' !== typeof t) return { type: 'message', data: C(t, e) }
        const s = t.charAt(0)
        if ('b' === s) return { type: 'message', data: A(t.substring(1), e) }
        return f[s] ? (t.length > 1 ? { type: f[s], data: t.substring(1) } : { type: f[s] }) : y
      }
      const T = String.fromCharCode(30)
      class N extends l.Q {
        constructor(t) {
          super(),
            (this.writable = !1),
        ...
        onError(t, e) {
          const s = new Error(t)
          return (s.type = 'TransportError'), (s.description = e), super.emit('error', s), this
        }
        open() {
          return (
        ...
        onData(t) {
          const e = R(t, this.socket.binaryType)
          this.onPacket(e)
        }
        onPacket(t) {
          super.emit('packet', t)
      ...
      class S extends N {
        ...
        uri() {
          ...
          let s = ''
          !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = B()),
      ...
      class q extends l.Q {
        ...
        cleanup(t) {
          if ('undefined' !== typeof this.xhr && null !== this.xhr) {
            if (((this.xhr.onreadystatechange = x), t))
              try {
                this.xhr.abort()
              } catch (e) {}
      ...
      if (((q.requestsCount = 0), (q.requests = {}), 'undefined' !== typeof document))
        if ('function' === typeof attachEvent) attachEvent('onunload', P)
          ...
          addEventListener('onpagehide' in o ? 'pagehide' : 'unload', P, !1)
        }
      function P() {
      ...
      class F extends N {
        ...
        doOpen() {
          ...
          try {
            this.ws = I ? new D(t, e, s) : e ? new D(t, e) : new D(t)
          } catch (n) {
        ...
        uri() {
          ...
          this.opts.port &&
            ...
            (s = ':' + this.opts.port),
            this.opts.timestampRequests && (t[this.opts.timestampParam] = B()),
        ...
        constructor(t, e = {}) {
          super(),
            ...
            t
              ...
              : e.host && (e.hostname = r(e.host).host),
            u(this, e),
            (this.secure =
              null != e.secure
                ? e.secure
      ...
      const V = 'function' === typeof ArrayBuffer,
        ...
        K =
          'function' === typeof Blob ||
          ('undefined' !== typeof Blob && '[object BlobConstructor]' === H.call(Blob)),
        Y =
          'function' === typeof File ||
          ('undefined' !== typeof File && '[object FileConstructor]' === H.call(File))
      function z(t) {
        return (
          (V &&
      ...
      function W(t, e) {
        ...
        if (Array.isArray(t)) {
          for (let e = 0, s = t.length; e < s; e++) if (W(t[e])) return !0
          return !1
        }
        if (z(t)) return !0
        if (t.toJSON && 'function' === typeof t.toJSON && 1 === arguments.length)
          return W(t.toJSON(), !0)
        for (const s in t) if (Object.prototype.hasOwnProperty.call(t, s) && W(t[s])) return !0
        return !1
      }
      function $(t) {
        const e = [],
          s = t.data,
          n = t
        return (n.data = J(s, e)), (n.attachments = e.length), { packet: n, buffers: e }
      }
      function J(t, e) {
        if (!t) return t
        if (z(t)) {
        ...
        if (Array.isArray(t)) {
          ...
          for (let n = 0; n < t.length; n++) s[n] = J(t[n], e)
          return s
        }
        if ('object' === typeof t && !(t instanceof Date)) {
          const s = {}
          for (const n in t) t.hasOwnProperty(n) && (s[n] = J(t[n], e))
          return s
        }
        return t
      }
      function Q(t, e) {
        return (t.data = X(t.data, e)), (t.attachments = void 0), t
      }
      function X(t, e) {
        if (!t) return t
        if (t && t._placeholder) return e[t.num]
        if (Array.isArray(t)) for (let s = 0; s < t.length; s++) t[s] = X(t[s], e)
        else if ('object' === typeof t)
          for (const s in t) t.hasOwnProperty(s) && (t[s] = X(t[s], e))
        return t
      }
      const G = 5
      var Z
      ...
      class et extends l.Q {
        ...
        decodeString(t) {
          ...
          if (void 0 === Z[s.type]) throw new Error('unknown packet type ' + s.type)
          ...
          if (t.charAt(++e)) {
            ...
            if (!et.isPayloadValid(s.type, n)) throw new Error('invalid payload')
            s.data = n
          }
          return s
        }
      ...
      class st {
        ...
        takeBinaryData(t) {
          if ((this.buffers.push(t), this.buffers.length === this.reconPack.attachments)) {
            const t = Q(this.reconPack, this.buffers)
      ...
      class it extends l.Q {
        ...
        emit(t, ...e) {
          if (rt.hasOwnProperty(t)) throw new Error('"' + t + '" is a reserved event name')
          e.unshift(t)
          const s = { type: Z.EVENT, data: e, options: {} }
          if (
        ...
        ack(t) {
          ...
          let s = !1
          return function (...n) {
            s || ((s = !0), e.packet({ type: Z.ACK, id: t, data: n }))
          }
        }
        onack(t) {
      ...
      class at extends l.Q {
        ...
        open(t) {
          ...
          this.engine = new U(this.uri, this.opts)
          const e = this.engine,
            s = this
        ...
        socket(t, e) {
          let s = this.nsps[t]
          return s || ((s = new it(this, t, e)), (this.nsps[t] = s)), s
        }
        _destroy(t) {
      ...
      function ht(t, e) {
        ...
        const s = (function (t, e = '', s) {
            ...
            ;(s = s || ('undefined' !== typeof location && location)),
              ...
              'string' === typeof t &&
                ('/' === t.charAt(0) && (t = '/' === t.charAt(1) ? s.protocol + t : s.host + t),
                /^(https?|wss?):\/\//.test(t) ||
                  (t = 'undefined' !== typeof s ? s.protocol + '//' + t : 'https://' + t),
                (n = r(t))),
              n.port ||
          ...
          i = s.id,
          o = s.path,
          a = ct[i] && o in ct[i].nsps
        let c
        return (
          e.forceNew || e['force new connection'] || !1 === e.multiplex || a
            ? (c = new at(n, e))
            : (ct[i] || (ct[i] = new at(n, e)), (c = ct[i])),
          s.query && !e.query && (e.query = s.queryKey),
          c.socket(s.path, e)
        )
      }
      Object.assign(ht, { Manager: at, Socket: it, io: ht, connect: ht })
    },
  },
])
