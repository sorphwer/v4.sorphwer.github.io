;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [176],
  {
    9671: function (u, D, F) {
      ...
      function B(u, D) {
        return 'string' !== typeof u
          ? ''
          : (D || (u = u.toLowerCase()), u.replace(C, '').replace(/ /g, '-'))
      }
      ;(A.prototype.slug = function (u, D) {
        const F = this
        let C = B(u, !0 === D)
        const A = C
        for (; E.call(F.occurrences, C); ) F.occurrences[A]++, (C = A + '-' + F.occurrences[A])
        return (F.occurrences[C] = 0), C
      }),
    ...
    4390: function (u, D, F) {
      ...
      var C = F(7320),
        ...
        n = function (u) {
          var D = u.text
          return 'notion' === (0, e.Z)(D)
            ? (0, C.tZ)(t.default, {
                href: '/tags/'.concat((0, e.Z)(D)),
                children: (0, C.BX)('a', {
                  className:
            ...
            : (0, C.tZ)(t.default, {
                ...
                children: (0, C.BX)('a', {
                  className:
                    'mt-1 mr-3 rounded border-2 border-solid border-primary-500 bg-gray-300 px-2 text-sm font-medium uppercase text-primary-500 transition duration-500 ease-out dark:border-primary-400 dark:bg-gray-500 dark:text-primary-400',
                  children: [
                    (0, C.tZ)(r.G, { icon: 'tags', className: 'text-black dark:text-gray-300 ' }),
                    ' ' + D.split(' ').join('-'),
                  ],
                }),
              })
      ...
      function d(u) {
        var D = u.posts,
          F = u.tag,
          t = u.all_tags,
          r = F[0].toUpperCase() + F.split(' ').join('-').slice(1),
          a = Object.keys(t).sort(function (u, D) {
            return t[D] - t[u]
          })
        return (0, C.BX)(C.HY, {
          children: [
            (0, C.tZ)(E.$t, {
              title: ''.concat(F, ' - ').concat(s().author),
              description: ''.concat(F, ' tags - ').concat(s().author),
            }),
            (0, C.BX)('div', {
              className:
              ...
              children: [
                ...
                (0, C.BX)('div', {
                  ...
                  children: [
                    ...
                    a.map(function (u) {
                      return (0,
                      C.BX)('div', { className: 'mt-2 mb-2 mr-5', children: [u === F ? (0, C.tZ)(n, { text: u }) : (0, C.tZ)(B.Z, { text: u }), (0, C.tZ)(A.Z, { href: '/tags/'.concat((0, e.Z)(u)), className: '-ml-2 text-sm font-semibold uppercase text-gray-600 dark:text-gray-300', children: ' ('.concat(t[u], ')') })] }, u)
                    }),
                  ],
                }),
              ],
            }),
            (0, C.tZ)(c.default, { posts: D, title: r, enableSearch: !1 }),
          ],
        })
      }
    },
  ...
  function (u) {
    u.O(0, [673, 888, 179], function () {
      return (D = 5271), u((u.s = D))
      var D
    })
    var D = u.O()
    _N_E = D
