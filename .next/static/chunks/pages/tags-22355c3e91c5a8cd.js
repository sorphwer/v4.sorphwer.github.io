;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [165],
  {
    ...
    9831: function (u, D, F) {
      ...
      var t = F(7320),
        ...
        A = function (u) {
          ...
          return (0, t.BX)(e.default, {
            children: [
              ...
              (0, t.tZ)('meta', {
                property: 'og:url',
                content: ''.concat(E().siteUrl).concat(B.asPath),
              }),
              (0, t.tZ)('meta', { property: 'og:type', content: C }),
              (0, t.tZ)('meta', { property: 'og:site_name', content: E().title }),
              (0, t.tZ)('meta', { property: 'og:description', content: F }),
              (0, t.tZ)('meta', { property: 'og:title', content: D }),
              'Array' === A.constructor.name
                ? A.map(function (u) {
                    var D = u.url
                    return (0, t.tZ)('meta', { property: 'og:image', content: D }, D)
                  })
                : (0, t.tZ)('meta', { property: 'og:image', content: A }, A),
              (0, t.tZ)('meta', { name: 'twitter:card', content: 'summary_large_image' }),
              (0, t.tZ)('meta', { name: 'twitter:site', content: E().twitter }),
              (0, t.tZ)('meta', { name: 'twitter:title', content: D }),
              (0, t.tZ)('meta', { name: 'twitter:description', content: F }),
              (0, t.tZ)('meta', { name: 'twitter:image', content: n }),
              (0, t.tZ)('link', {
                rel: 'canonical',
                href: a || ''.concat(E().siteUrl).concat(B.asPath),
              }),
            ],
          })
        },
        n = function (u) {
          var D = u.title,
            F = u.description,
            e = E().siteUrl + E().socialBanner,
            r = E().siteUrl + E().socialBanner
          return (0, t.tZ)(A, {
            title: D,
            description: F,
            ogType: 'website',
        ...
        a = function (u) {
          var D = u.title,
            F = u.description,
            C = E().siteUrl + E().socialBanner,
            n = E().siteUrl + E().socialBanner,
            a = (0, r.useRouter)()
          return (0, t.BX)(t.HY, {
            children: [
              (0, t.tZ)(A, { title: D, description: F, ogType: 'website', ogImage: C, twImage: n }),
              (0, t.tZ)(e.default, {
                children: (0, t.tZ)('link', {
                  rel: 'alternate',
                  type: 'application/rss+xml',
                  title: ''.concat(F, ' - RSS feed'),
                  href: ''.concat(E().siteUrl).concat(a.asPath, '/feed.xml'),
                }),
              }),
            ],
          })
        ...
        B = function (u) {
          var D = u.authorDetails,
            ...
            o = void 0 === i ? [] : i,
            c = u.canonicalUrl,
            s = ((0, r.useRouter)(), new Date(n).toISOString()),
            l = new Date(a || n).toISOString(),
            d = (0 === o.length ? [E().socialBanner] : 'string' === typeof o ? [o] : o).map(
              function (u) {
                return { '@type': 'ImageObject', url: u.includes('http') ? u : E().siteUrl + u }
              }
            ),
            m = {
              '@context': 'https://schema.org',
              '@type': 'Article',
              mainEntityOfPage: { '@type': 'WebPage', '@id': B },
              headline: F,
              image: d,
              datePublished: s,
              dateModified: l,
              ...
              publisher: {
                '@type': 'Organization',
                name: E().author,
                logo: { '@type': 'ImageObject', url: ''.concat(E().siteUrl).concat(E().siteLogo) },
              },
              description: C,
            },
            p = d[0].url
          return (0, t.BX)(t.HY, {
            children: [
              ...
              (0, t.BX)(e.default, {
                children: [
                  n && (0, t.tZ)('meta', { property: 'article:published_time', content: s }),
                  a && (0, t.tZ)('meta', { property: 'article:modified_time', content: l }),
                  (0, t.tZ)('script', {
        ...
        return 'notion' === (0, r.Z)(D)
          ...
          : (0, t.tZ)(e.default, {
              ...
              children: (0, t.BX)('a', {
                ...
                children: [
                  (0, t.tZ)(C.G, { icon: 'tags', className: 'text-black dark:text-gray-300 ' }),
                  ' ' + D.split(' ').join('-'),
                ],
              }),
            })
    ...
    4288: function (u, D, F) {
      ...
      function B(u) {
        var D = u.tags,
          F = Object.keys(D).sort(function (u, F) {
            return D[F] - D[u]
          })
        return (0, t.BX)(t.HY, {
          children: [
            ...
            (0, t.BX)('div', {
              ...
              children: [
                ...
                (0, t.BX)('div', {
                  ...
                  children: [
                    0 === Object.keys(D).length && 'No tags found.',
                    F.map(function (u) {
                      return (0,
                      t.BX)('div', { className: 'mt-2 mb-2 mr-5', children: [(0, t.tZ)(C.Z, { text: u }), (0, t.tZ)(e.Z, { href: '/tags/'.concat((0, n.Z)(u)), className: '-ml-2 text-sm font-semibold uppercase text-gray-600 dark:text-gray-300', children: ' ('.concat(D[u], ')') })] }, u)
                    }),
                  ],
                }),
              ],
