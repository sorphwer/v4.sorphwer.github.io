;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [405],
  {
    9671: function (u, D, e) {
      ...
      ;(r.prototype.slug = function (u, D) {
        ...
        let t = a(u, !0 === D)
        const r = t
        for (; F.call(e.occurrences, t); ) e.occurrences[r]++, (t = r + '-' + e.occurrences[r])
        return (e.occurrences[t] = 0), t
      }),
    ...
    7726: function (u, D, e) {
      ...
      function o(u, D, e, t, F, r, a) {
        ...
        n.done ? D(i) : Promise.resolve(i).then(t, F)
      }
      var c = function (u) {
        var D = u.title,
          e = void 0 === D ? 'Subscribe to the newsletter' : D,
          t = (0, a.useRef)(null),
          n = (0, a.useState)(!1),
          c = n[0],
          s = n[1],
                  ...
                  return F().wrap(function (u) {
                    for (;;)
                      switch ((u.prev = u.next)) {
                        ...
                        case 3:
                          return (e = u.sent), (u.next = 6), e.json()
                        case 6:
                          if (!u.sent.error) {
                            u.next = 11
                            break
                ...
                (0, r.BX)('div', {
                  children: [
                    ...
                    (0, r.tZ)('input', {
                      ...
                      id: 'email-input',
                      name: 'email',
                      placeholder: d ? "You're subscribed !  \ud83c\udf89" : 'Enter your email',
                      ref: t,
                      required: !0,
                      type: 'email',
                      disabled: d,
                  ...
                  children: (0, r.tZ)('button', {
                    className:
                      'w-full rounded-md bg-primary-500 py-2 px-4 font-medium text-white sm:py-0 '.concat(
                        d ? 'cursor-default' : 'hover:bg-primary-700 dark:hover:bg-primary-400',
                        ' focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 dark:ring-offset-black'
                      ),
                    type: 'submit',
                    disabled: d,
                    children: d ? 'Thank you!' : 'Sign up',
                  }),
                }),
              ],
            }),
      ...
      var t = e(7320),
        ...
        i = function (u) {
          var D = u.title,
            ...
            c = u.canonicalUrl,
            s = (0, r.useRouter)()
          return (0, t.BX)(F.default, {
            children: [
              (0, t.tZ)('title', { children: D }),
              (0, t.tZ)('meta', { name: 'robots', content: 'follow, index' }),
              (0, t.tZ)('meta', { name: 'description', content: e }),
              (0, t.tZ)('meta', {
                property: 'og:url',
                content: ''.concat(n().siteUrl).concat(s.asPath),
              }),
              (0, t.tZ)('meta', { property: 'og:type', content: a }),
              (0, t.tZ)('meta', { property: 'og:site_name', content: n().title }),
              (0, t.tZ)('meta', { property: 'og:description', content: e }),
              ...
              (0, t.tZ)('meta', { name: 'twitter:site', content: n().twitter }),
              (0, t.tZ)('meta', { name: 'twitter:title', content: D }),
              (0, t.tZ)('meta', { name: 'twitter:description', content: e }),
              (0, t.tZ)('meta', { name: 'twitter:image', content: o }),
              (0, t.tZ)('link', {
                rel: 'canonical',
                href: c || ''.concat(n().siteUrl).concat(s.asPath),
              }),
            ],
          })
        },
        o = function (u) {
          var D = u.title,
            e = u.description,
            F = n().siteUrl + n().socialBanner,
            r = n().siteUrl + n().socialBanner
          return (0, t.tZ)(i, {
            title: D,
            description: e,
            ogType: 'website',
        ...
        c = function (u) {
          var D = u.title,
            e = u.description,
            a = n().siteUrl + n().socialBanner,
            o = n().siteUrl + n().socialBanner,
            c = (0, r.useRouter)()
          return (0, t.BX)(t.HY, {
            children: [
              (0, t.tZ)(i, { title: D, description: e, ogType: 'website', ogImage: a, twImage: o }),
              (0, t.tZ)(F.default, {
                children: (0, t.tZ)('link', {
                  rel: 'alternate',
                  type: 'application/rss+xml',
                  title: ''.concat(e, ' - RSS feed'),
                  href: ''.concat(n().siteUrl).concat(c.asPath, '/feed.xml'),
                }),
              }),
            ],
          })
        ...
        s = function (u) {
          var D = u.authorDetails,
            ...
            E = void 0 === C ? [] : C,
            l = u.canonicalUrl,
            A = ((0, r.useRouter)(), new Date(o).toISOString()),
            d = new Date(c || o).toISOString(),
            B = (0 === E.length ? [n().socialBanner] : 'string' === typeof E ? [E] : E).map(
              function (u) {
                return { '@type': 'ImageObject', url: u.includes('http') ? u : n().siteUrl + u }
              }
            ),
            m = {
              ...
              author: D
                ? D.map(function (u) {
                    return { '@type': 'Person', name: u.name }
                  })
                : { '@type': 'Person', name: n().author },
              publisher: {
                '@type': 'Organization',
                name: n().author,
                logo: { '@type': 'ImageObject', url: ''.concat(n().siteUrl).concat(n().siteLogo) },
              },
              description: a,
            },
            p = B[0].url
          return (0, t.BX)(t.HY, {
            children: [
              ...
              (0, t.BX)(F.default, {
                children: [
                  o && (0, t.tZ)('meta', { property: 'article:published_time', content: A }),
                  c && (0, t.tZ)('meta', { property: 'article:modified_time', content: d }),
                  (0, t.tZ)('script', {
        ...
        return 'notion' === (0, r.Z)(D)
          ...
          : (0, t.tZ)(F.default, {
              ...
              children: (0, t.BX)('a', {
                ...
                children: [
                  (0, t.tZ)(a.G, { icon: 'tags', className: 'text-black dark:text-gray-300 ' }),
                  ' ' + D.split(' ').join('-'),
                ],
              }),
            })
    ...
    6232: function (u, D, e) {
      ...
      var t = e(1576),
        F = e.n(t)
      D.Z = function (u) {
        return new Date(u).toLocaleDateString(F().locale, {
          year: 'numeric',
          month: 'long',
          day: 'numeric',
        })
                  ...
                  children: [
                    ...
                    D.slice(0, 5).map(function (u) {
                      var D = u.slug,
                        ...
                        n = u.summary,
                        i = u.tags,
                        c = Math.floor((new Date(e).getMonth() / 12) * 4) % 4
                      return (0, t.tZ)(
                        'li',
                        {
                          className: 'py-12',
  ...
  function (u) {
    u.O(0, [888, 179], function () {
      return (D = 8581), u((u.s = D))
      var D
    })
    var D = u.O()
    _N_E = D
