  ...
  [853],
  {
    ...
    584: function (n, e, t) {
      var r = t(1720),
        i = t(6362)
      e.Z = function (n, e, t) {
        if (!i.jU) return [e, i.ZT, i.ZT]
        if (!n) throw new Error('useLocalStorage key may not be falsy')
        var u = t
            ? t.raw
              ? function (n) {
                  return n
        ...
        var s = (0, r.useCallback)(
          ...
          l = (0, r.useCallback)(
            function () {
              try {
                localStorage.removeItem(n), f(void 0)
              } catch (c) {}
            },
            [n, f]
          )
    ...
    2977: function (n, e, t) {
      ...
      var r = t(1720),
        ...
        a = function (n, e) {
          ...
          var t = o({ width: c.jU ? window.innerWidth : n, height: c.jU ? window.innerHeight : e }),
            i = t[0],
            u = t[1]
          return (
            (0, r.useEffect)(function () {
              if (c.jU) {
                ...
                return (
                  (0, c.on)(window, 'resize', n),
                  function () {
                    ;(0, c.S1)(window, 'resize', n)
                  }
                )
              }
            }, []),
